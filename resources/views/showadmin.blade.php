...
<div>
    ...
    <form method="POST" action="{{ url('/contactadmin',$user_id) }}" enctype="multipart/form-data">
        ...
        <div style="width: 310px" >
            ...
            <input type="hidden" name="sender" value="user_sender" />
                {{ __('Add_New_Massage') }}
            </x-jet-button>
        </div>
    </form>  
